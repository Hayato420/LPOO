...
public class GerenciadorDeCombate{
    ...
    private void exibirEstados(){
        ...
        System.out.println(jogador.getStatus().exibirStatus());
        System.out.println("");
        ...
        Arma arma = jogador.getArmaEquipada();
        if(arma != null){
            if(arma.getMaterial1().getTipoDeMaterial() == arma.getMaterial2().getTipoDeMaterial()){
                System.out.println("Arma equipada: " + arma.getNome() + " de " + arma.getMaterial1().getNome());
            }
            else{
                System.out.println("Arma equipada: " + arma.getNome() + " de " + arma.getMaterial1().getNome() + " e " + arma.getMaterial2().getNome());
            }
        } else{
